...
const BASE_URLS = {
  ...
  PATIENT_AUTH: `${API_V1}/patients/auth`,
};
...
export const STATIC_ENDPOINTS = {
  ...
  PATIENT_AUTH: {
    SET_PASSWORD: `${BASE_URLS.PATIENT_AUTH}/password`,
    SIGNUP: `${BASE_URLS.PATIENT_AUTH}/signup`,
    SIGNIN: `${BASE_URLS.PATIENT_AUTH}/signin`,
    REFRESH_TOKEN: `${BASE_URLS.PATIENT_AUTH}/refresh-token`,
    FORGOT_PASSWORD: `${BASE_URLS.PATIENT_AUTH}/password/forgot`,
    VERIFY_OTP: `${BASE_URLS.PATIENT_AUTH}/otp/verify`,
    SEND_OTP: `${BASE_URLS.PATIENT_AUTH}/otp/send`,
    LOGOUT: `${BASE_URLS.PATIENT_AUTH}/logout`,
    CHECK_CONTACT: `${BASE_URLS.PATIENT_AUTH}/contact/check`,
  },
...
export const PUBLIC_ENDPOINTS = [
  ...
  STATIC_ENDPOINTS.PATIENT_AUTH.SET_PASSWORD,
  STATIC_ENDPOINTS.PATIENT_AUTH.SIGNUP,
  STATIC_ENDPOINTS.PATIENT_AUTH.SIGNIN,
  STATIC_ENDPOINTS.PATIENT_AUTH.REFRESH_TOKEN,
  STATIC_ENDPOINTS.PATIENT_AUTH.FORGOT_PASSWORD,
  STATIC_ENDPOINTS.PATIENT_AUTH.VERIFY_OTP,
  STATIC_ENDPOINTS.PATIENT_AUTH.SEND_OTP,
  STATIC_ENDPOINTS.PATIENT_AUTH.CHECK_CONTACT,
];
