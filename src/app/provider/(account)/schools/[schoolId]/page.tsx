      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="mb-8">
          <div className="flex items-start gap-6">
            {school.logo ? (
              <div className="relative w-32 h-32 rounded-2xl overflow-hidden border-2 border-gray-200 bg-white shrink-0">
                <Image
                  src={school.logo}
                  alt={school.name}
                  fill
              ...
              <div className="w-32 h-32 bg-gray-100 rounded-2xl flex items-center justify-center shrink-0">
            ...
            <div className="pt-2">
              ...
              {school.nickname && (
                <p className="text-gray-600 text-base">@{school.nickname}</p>
              )}
              {school.type && (
