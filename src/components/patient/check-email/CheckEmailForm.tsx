  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-2xl">
      <div className="flex flex-col">
        <Label className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-muted-foreground pl-2 md:pl-4 mb-2">
        ...
        <div className="relative flex">
          <Input
            ...
            className={`font-bold w-full rounded-l-xl border-4 border-r-0 ${
              errors?.email?.message ? "border-destructive" : "border-success"
            } text-base sm:text-lg md:text-xl lg:text-2xl text-foreground p-3 md:p-4 bg-muted/50 focus:outline-none`}
          />
          <Button
            type="submit"
            variant="ghost"
