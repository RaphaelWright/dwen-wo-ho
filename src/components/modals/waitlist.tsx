...
import { WaitlistModalProps } from "@/types/modals";

const WaitListModal = ({ isOpen, onClose }: WaitlistModalProps) => {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const [open, setOpen] = useState(false); // Unused local state if controlled? No, the parent controls it.

  // Actually, ResponsiveDialog likely needs 'open' and 'setOpen'.
  // If we receive isOpen and onClose, we construct:
  // open={isOpen} onOpenChange={(val) => !val && onClose()}
