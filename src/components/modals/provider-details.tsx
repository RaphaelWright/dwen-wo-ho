...
import { ProviderDetailsModalProps, ProviderDetailsTab } from "@/types/modals";
...
const ProviderDetailsModal = ({
  ...
  const getStatusBadge = () => {
    ...
    return (
      <span
        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-semibold ${config.bg} ${config.text} border ${config.border}`}
      >
                ...
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    {provider?.specialties &&
                      ...
                      provider.specialties.some((s) => s && s.trim()) && (
                        <div>
                          <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                              ...
                              {filteredAvailableSchools.map((school) => {
                                ...
                                return (
                                  ...
                                  >
                                      ...
                                      <div>
                                        ...
                                        {isRejected && (
                                          <p className="text-xs text-gray-400 mt-1">
                                            Cannot add schools to rejected
                                            providers
                                          </p>
                                        )}
                                      </div>
                                    ...
                                    <button
                                      onClick={() =>
                                        !isRejected && setSchoolToAdd(school)
                                      }
                                      disabled={isRejected}
              ...
              {provider?.applicationStatus === "PENDING" && (
                <div className="flex gap-2 flex-1">
                  ...
                  >
                    ...
                    moderatingProviderEmail === providerEmail ? (
                      <>
