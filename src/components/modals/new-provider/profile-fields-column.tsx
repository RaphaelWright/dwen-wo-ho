...
export default function ProfileFieldsColumn({
  ...
  return (
    <div className="w-1/2 p-6 border-r flex flex-col gap-1.5 overflow-hidden overflow-y-auto no-scrollbar shrink-0">
      {/* ── Editable ── */}
...
function FieldRow({
  ...
  return (
    ...
    >
      ...
      <span className="text-[13px] font-medium flex-1 truncate">{value}</span>
