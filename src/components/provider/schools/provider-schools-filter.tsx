...
import { ProviderSchoolsFilterProps } from "@/lib/types/components/provider/schools";
import { filterOptions } from "@/lib/constants/components/provider/schools/schools";
