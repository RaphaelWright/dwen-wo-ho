...
const INITIAL_CHARACTER = LANDING_2_CHARACTERS[0];

export function Landing2HeroSection() {
  return (
    <div
      className="l2-hero l2-hero-artifacts"
      id="hero"
      style={{
        maskImage:
    ...
    >
      ...
      <Image
        className={cn(
          "l2-photo photo relative z-10 transition-opacity duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]",
        )}
        id="l2-photo"
