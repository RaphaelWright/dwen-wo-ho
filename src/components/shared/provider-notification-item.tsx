...
/**
 * Provider-specific notification item.
 * Displays provider notifications with targetName (patient), text, and meta.
 */
export interface ProviderNotificationItemProps {
  notif: Notification;
  index: number;
  onMarkRead: () => void;
  onDelete?: () => void;
...
export function ProviderNotificationItem({
  notif,
  index,
  onMarkRead,
  onDelete,
      ...
      >
        ...
        <Avatar className="size-9 shrink-0 border border-border">
          ...
          <AvatarFallback className="text-foreground">
            {(notif.targetName || "N").charAt(0).toUpperCase()}
          </AvatarFallback>
        </Avatar>
