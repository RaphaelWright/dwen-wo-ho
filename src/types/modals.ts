...
import { Partner } from "./school";
import { SchoolProvider, ProviderDetails } from "./provider";
import { PatientResultItem, UrgentCarePatient } from "./patient";
import { LockInStudent } from "./lockin";
