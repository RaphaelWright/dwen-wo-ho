...
import {
  ...
  LOCK_IN_2_CONTENT,
  LOCK_IN_2_TIMING,
} from "@/_unused/lib/marketing/landing-2";
import type { LockIn2Character } from "@/_unused/lib/types/marketing/landing-2";
import {
  loadHeroPaletteFromPhoto,
  resetHeroPalette,
} from "@/_unused/lib/hero-palette";
import { typeText } from "@/_unused/lib/type-text";
